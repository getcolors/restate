...
grep -q "colors-compute.git\", rev = \"$compute_sha\"" "$root/skills/package-restate-blue/blue"
...
# missing peer.
red_launcher="$root/skills/package-restate-red/red"
...
[[ -f "$tmp/red-cold/.colors/restate-fixture/compute/shared/backend.tf.json" ]]
